...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.Categorie", b =>
                {
            ...
            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.CategorieLigneAnnuaire", b =>
                {
                    b.Property<int>("IdCategorie")
                        .HasColumnType("int");

                    b.Property<int>("IdLigneAnnuaire")
                        .HasColumnType("int");

                    b.HasKey("IdCategorie", "IdLigneAnnuaire");

                    b.HasIndex("IdLigneAnnuaire");

                    b.ToTable("CategorieLigneAnnuaires");
                });

            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.Contact", b =>
                {
                    ...
                    b.Property<int>("IdTitreCivilite")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdTitreCivilite");

                    b.ToTable("Contacts");
                });

            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.ContactLigneAnnuaire", b =>
                {
                    b.Property<int>("IdContact")
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdContact", "IdLigneAnnuaire");

                    b.HasIndex("IdLigneAnnuaire");

                    b.ToTable("ContactLigneAnnuaires");
                });

            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.ContactStructure", b =>
                {
                    b.Property<int>("IdContact")
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdContact", "IdStructure");

                    b.HasIndex("IdStructure");

                    b.ToTable("ContactStructures");
                });

            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.LigneAnnuaire", b =>
                {
                    b.Property<int>("IdLigneAnnuaire")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("PublicConcerne")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");
                    ...
                    b.Property<string>("ServiceAbrege")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");

                    b.HasKey("IdLigneAnnuaire");

                    b.HasIndex("IdStructure");

                    b.ToTable("LigneAnnuaires");
                });

            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.Structure", b =>
                {
                    b.Property<int>("IdStructure")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("LigneAdresse1")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");

                    b.Property<string>("LigneAdresse2")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");

                    b.Property<string>("LigneAdresse3")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.CategorieLigneAnnuaire", b =>
                {
                    b.HasOne("AppAfpaBrive.BOL.AnnuaireSocial.Categorie", "Categorie")
                        .WithMany("CategorieLigneAnnuaires")
                        .HasForeignKey("IdCategorie")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppAfpaBrive.BOL.AnnuaireSocial.LigneAnnuaire", "LigneAnnuaire")
                        .WithMany("CategorieLigneAnnuaires")
                        .HasForeignKey("IdLigneAnnuaire")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Categorie");

                    b.Navigation("LigneAnnuaire");
                });

            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.Contact", b =>
                {
                    b.HasOne("AppAfpaBrive.BOL.TitreCivilite", "TitreCivilite")
                        .WithMany("Contacts")
                        .HasForeignKey("IdTitreCivilite")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TitreCivilite");
                });

            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.ContactLigneAnnuaire", b =>
                {
                    b.HasOne("AppAfpaBrive.BOL.AnnuaireSocial.Contact", "Contact")
                        .WithMany("ContactLigneAnnuaires")
            ...
            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.ContactStructure", b =>
                {
                    b.HasOne("AppAfpaBrive.BOL.AnnuaireSocial.Contact", "Contact")
                        .WithMany("ContactStructures")
                        .HasForeignKey("IdContact")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppAfpaBrive.BOL.AnnuaireSocial.Structure", "Structure")
                        .WithMany("ContactStructures")
            ...
            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.Categorie", b =>
                {
                    b.Navigation("CategorieLigneAnnuaires");
                });

            modelBuilder.Entity("AppAfpaBrive.BOL.AnnuaireSocial.Contact", b =>
                {
                    b.Navigation("ContactLigneAnnuaires");

                    b.Navigation("ContactStructures");
                });
